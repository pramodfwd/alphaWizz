...
export const getPoints = places => {
  const p1 = [places.pickupLocation.latitude, places.pickupLocation.longitude];
  const p2 = [
    places.deliveryLocation.latitude,
    places.deliveryLocation.longitude,
  ];
...
//     "pickupLocation": {
//         "latitude": 23.232809,
//         "address": "Maharana Pratap Nagar, Bhopal, Madhya Pradesh 462023 ",
//         "longitude": 77.432238
//     },
//     "deliveryLocation": {
//         "latitude": 23.219337,
